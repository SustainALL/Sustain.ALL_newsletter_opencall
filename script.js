...
const projects = [
  ...
  },
  {
    ...
    description: "Analyzing campus commuter flows to optimize low-carbon transport infrastructure and bike connectivity.",
  ...
  },
  {
    ...
    status: "PRE-PROTOTYPE",
    description: "Fostering inclusive decision-making hubs for student sustainability initiatives and campus social labs.",
  ...
  },
  {
    ...
    cluster: "People, Society & Wellbeing",
    status: "PROTOTYPE",
    description: "Developing regional, seasonal canteen supply loops across campus dining facilities to lower carbon footprint.",
    partner: "Studierendenwerk Berlin"
  }
];

// Helper Function to Map Clusters to Category Types
function getClusterType(clusterName) {
  const enablers = [
    'AI, Data & Digital Sustainability', 
    'Sustainable Finance', 
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      e.preventDefault();
      alert('Thank you for submitting your challenge! The Sustain.ALL team will review it shortly.');
      form.reset();
    });
  }
});